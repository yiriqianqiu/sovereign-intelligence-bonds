...
|---|---|---|
| Smart Contracts | Hardhat 3 + Solidity 0.8.28 + OpenZeppelin 5.4 | 18 production contracts, 695 tests |
...
| Frontend | Next.js 14 + wagmi v2 + RainbowKit + Tailwind CSS | 14 pages, 5 API routes, 8 hooks |
...
| SIBControllerV2 | 0xD1B48E15Fa47B5AeA35A2f8327Bd8773fb4826d4 | Core controller (IPO/dividends/proof/TEE) |
...
| X402PaymentReceiverV2 | 0xFe053fFa3F3A873Bfc5f65E5000D4e4FcD4C8c1F | x402 micropayment receiver |
...
| GreenfieldDataVault | 0x553e9ADF83df29aE84f9C1b4FA1505567cf421Cd | Decentralized data vault |
| ComputeMarketplace | 0x22bEa0382eb3295d2028bB9d5767DE73f52c2F5e | Agent compute marketplace |
| TokenRegistry | 0xC5824Ce1cbfFC4A13C2C31191606407de100eB65 | Token whitelist + pricing |
| TEERegistry | 0x29212A3E489236B56Ea4e383da78b6d2EF347Cf3 | TEE delegation + attestation |
...
- **Revenue relay**: TEE agent forwards x402 payments with authorized relay restriction
...
sovereign-intelligence-bonds/
  contracts/           Hardhat 3, 18 Solidity contracts, 695 tests
  src/                 Next.js 14 frontend (14 pages, 8 hooks, 6 components)
